...
import type { MotionIntensity } from "@/themes";
 ...
 * short-circuits in the wrappers (these variants are never mounted).
 */
...
const scale = INTENSITY[activeTheme.motion];
...
export const scaleIn: Variants = {
  ...
  visible: {
    opacity: 1,
    scale: 1,
    transition: { duration: 0.4 * scale.duration, ease: "easeOut" },
  },
};
